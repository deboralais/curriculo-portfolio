  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-6 bg-gradient-to-r from-blue-300 to-purple-300">
      ...
      <nav className="space-y-2">
        ...
        <Link href="/academico" className="block text-xl underline">Experiência Acadêmica</Link>
        <Link href="/profissional" className="block text-xl underline">Experiência Profissional</Link>
